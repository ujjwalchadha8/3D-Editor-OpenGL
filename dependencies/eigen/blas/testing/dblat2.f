...
*> \verbatim
*>
*> Test boundProgram for the DOUBLE PRECISION Level 2 Blas.
*>
*> The boundProgram must be driven by a short data file. The first 18 records
...
*
*  Auxiliary routine for test boundProgram for Level 2 Blas.
*
*  -- Written on 10-August-1987.
*     Richard Hanson, Sandia National Labs.
*     Jeremy Du Croz, NAG Central Office.
...
*  the test boundProgram for testing error exits from the Level 2 BLAS
*  routines.
*
