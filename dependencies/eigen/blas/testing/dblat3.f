...
*> \verbatim
*>
*> Test boundProgram for the DOUBLE PRECISION Level 3 Blas.
*>
*> The boundProgram must be driven by a short data file. The first 14 records
...
*  Tests DGEMM.
*
*  Auxiliary routine for test boundProgram for Level 3 Blas.
*
*  -- Written on 8-February-1989.
*     Jack Dongarra, Argonne National Laboratory.
*     Iain Duff, AERE Harwell.
...
*  the test boundProgram for testing error exits from the Level 3 BLAS
*  routines.
*
